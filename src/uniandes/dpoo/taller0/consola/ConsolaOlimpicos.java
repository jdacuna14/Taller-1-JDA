...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le muestra al usuario el país al que representa el atleta
	 */
	private void ejecutarPaisdelAtleta()
	{
		System.out.println("\n" + "País al que representa un atleta" + "\n");

		String natleta = input("Por favor ingrese el nombre del atleta");
		Atleta atleta = calculadora.buscarAtleta(natleta);
		String pais = atleta.darPais().darNombre();
		
		System.out.println("El país al que representa el atleta consultado es " + pais + ".");
	}
